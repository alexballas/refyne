...
- glfw/src/wl_refyne.c — Wayland move/resize/window-menu/decoration-mode helpers + xdg-toplevel-icon setter + cached CSD shadows
...
- glfw/src/wl_platform.h + glfw/src/wl_window.c — per-window shadow state + resize/lifecycle hooks
